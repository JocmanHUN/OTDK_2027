...
@dataclass
class VetoShiftModel(BasePredictiveModel):
    """Veto model with xG margin shift applied to final probabilities."""

    name: ClassVar[ModelName] = ModelName.VETO_SHIFT
    ...
    margin_weight: float = 0.6  # scale for xG margin difference effect
    margin_clip: float = 2.0  # clamp shift magnitude
